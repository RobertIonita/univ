...
int main()
{
    ...
    writeStatistics("AA/Comparisons/assets/BTSunbalanced.txt", root, keys, n);
    printf("\nUnbalanced tree:");
    unbalanced = analyseStatistics("AA/Comparisons/assets/BTSunbalanced.txt");

    root = balanceTree(root);
    writeStatistics("AA/Comparisons/assets/BTSbalanced.txt", root, keys, n);
    printf("\n\nBalanced tree:");
    balanced = analyseStatistics("AA/Comparisons/assets/BTSbalanced.txt");
